...
The Docker image uses the [original MATLAB implementation](https://de.mathworks.com/matlabcentral/fileexchange/74200-cell-segmentation-rfove-method) and makes it accessible without requiring any dependencies or license keys. The [LICENSE](https://github.com/kostrykin/rfove/blob/master/rfove/LICENSE) file applies to the original implementation.
